...
class ExpenseViewSet(viewsets.ModelViewSet):
    ...
    def monthly(self, request):
        # TruncMonth SQLite da None qiymatda xato berishi mumkin
        data = (
            Expense.objects
            .filter(expense_date__isnull=False)
...
class ReportViewSet(viewsets.ViewSet):
    ...
    def daily_revenue(self, request):
        ...
        today = date.today()
        # TruncDate SQLite da None qiymatda exception tashlashi mumkin.
        # payment_date allaqachon DateField — TruncDate shart emas.
        data = (
            Payment.objects
            .filter(
        ...
        # Frontend 'day' kalitini kutishi mumkin — moslashtirish
        result = [
            {
